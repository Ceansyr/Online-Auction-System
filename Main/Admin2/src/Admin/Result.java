...
public class Result extends JPanel {
	...
	public void refresh() throws Exception
	{
		...
		while(i.hasNext())
		{
			item=i.next();
			Barray=item.b;
			File file=new File("C:\\Users\\rajan\\Desktop\\Online-Auction-System-master\\Admin2\\AdminImages"+String.valueOf(item.ID)+".txt");
			fos=new FileOutputStream(file);
			fos.write(Barray);
			image=new ImageIcon("C:\\Users\\rajan\\Desktop\\Online-Auction-System-master\\Admin2\\AdminImages"+String.valueOf(item.ID)+".txt");
