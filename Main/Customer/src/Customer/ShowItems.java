...
public class ShowItems extends JPanel {
	...
	public ShowItems(ObjectInputStream input,ObjectOutputStream output) throws Exception {
		...
		while(i.hasNext())
		{
			item=i.next();
			Barray=item.b;
			File file=new File("C:\\Users\\rajan\\Desktop\\Online-Auction-System-master\\Customer\\CustomerImages\\"+String.valueOf(item.ID)+".txt");
			fos=new FileOutputStream(file);
			fos.write(Barray);
			image=new ImageIcon("C:\\Users\\rajan\\Desktop\\Online-Auction-System-master\\Customer\\CustomerImages\\"+String.valueOf(item.ID)+".txt");
